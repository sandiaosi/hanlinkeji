   ...
   <div class="row">
       <div class="col-xs-12">
           ...
           <div class="alert alert-info">
               ...
               Please note that demo server is not configured to save the changes, therefore you may see an error
               message.
           </div>
...
<script src="${base}/webstatic/assets/js/bootstrap-datepicker.min.js"></script>
<script src="${base}/webstatic/assets/js/jquery.jqGrid.min.js"></script>
<script src="${base}/webstatic/assets/js/grid.locale-en.js"></script>
</@override>
